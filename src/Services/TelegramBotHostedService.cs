...
namespace Scangram.Services
{
    ...
    public class TelegramBotHostedService : HostedService
    {
        ...
        public TelegramBotHostedService(IServiceProvider serviceProvider, ITelegramBotClient telegramBotClient, ILogger<TelegramBotHostedService> logger, IMemoryCache cache, IWorkerService workerService) : base(serviceProvider)
        {
            _logger = logger;
            _cache = cache;
